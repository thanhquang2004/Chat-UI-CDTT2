...
export type Chat = {
  ...
  member: Array<Scalars['String']['output']>;
  name: Scalars['String']['output'];
};

export type CreateChatInput = {
  isPrivate: Scalars['Boolean']['input'];
  member: Array<Scalars['String']['input']>;
...
export type ChatFragmentFragment = { __typename?: 'Chat', _id: string, name: string, isPrivate: boolean, member: Array<string>, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null };

export type MessageFragmentFragment = { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } };
...
export type CreateChatMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', _id: string, name: string, isPrivate: boolean, member: Array<string>, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null } };
...
export type CreateMessageMutation = { __typename?: 'Mutation', createMessage: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } };
...
export type ChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', _id: string, name: string, isPrivate: boolean, member: Array<string>, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null } };
...
export type ChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, name: string, isPrivate: boolean, member: Array<string>, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null }> };
...
export type MessagesQuery = { __typename?: 'Query', messages: Array<{ __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } }> };
...
export type MessageCreatedSubscription = { __typename?: 'Subscription', messageCreated: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } };
...
export const MessagesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Messages"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"chatId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"skip"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"messages"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"chatId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"chatId"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"Argument","name":{"kind":"Name","value":"skip"},"value":{"kind":"Variable","name":{"kind":"Name","value":"skip"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MessageFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MessageFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Message"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createAt"}},{"kind":"Field","name":{"kind":"Name","value":"chatId"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserFragment"}}]}}]}}]} as unknown as DocumentNode<MessagesQuery, MessagesQueryVariables>;
